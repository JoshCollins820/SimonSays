...
// IN NHD.cpp MODIFY THE FOLLOWING

// SPI spi(SPI_MOSI, NC, SPI_SCLK) // change NC to SPI_MISO and define above #define SPI_MOSI = D12
...
void init_lcd(void) {
	...
	*/
    ...
    wait_ms(50); // wait for 40 ms
    write_cmd(0x30);
    wait_us(50); // wait for 50 us
    write_cmd(0x20); 
    wait_us(50); // wait for 50 us
    write_cmd(0x20); 
    wait_us(50); // wait for 50 us
